export const WISH_CALLBACK_DATA = {
  ...
  enableFavoriteNotification: 'enable_notification',
  disableFavoriteNotification: 'disable_notification',
...
export const WISH_SCENE_NEXT_NAME = 'wishNextScene'
export const WISH_SCENE_EDIT_NAME_SCENE = 'wishEditNameScene'
