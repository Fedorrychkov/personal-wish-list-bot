export const codes = {
  ...
  TRANSACTION_NOT_ENOUGH_BALANCE_FOR_MINIMAL_WITHDRAWAL: 'TRANSACTION_NOT_ENOUGH_BALANCE_FOR_MINIMAL_WITHDRAWAL',
  ...
  TRANSACTION_TARGET_WALLET_ADDRESS_EMPTY: 'TRANSACTION_TARGET_WALLET_ADDRESS_EMPTY',
}
...
export const errors = {
  ...
  messages: {
    ...
    [codes.TRANSACTION_NOT_ENOUGH_BALANCE_FOR_MINIMAL_WITHDRAWAL]:
      'Минимальная сумма вывода не может быть менее {minWithdrawalAmount} {currency}',
    [codes.TRANSACTION_TARGET_WALLET_ADDRESS_EMPTY]: 'Некорректный адрес для перевода',
  },
}
